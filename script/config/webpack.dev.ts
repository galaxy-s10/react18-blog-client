  ...
  portfinder
    ...
    .then((port) => {
      const devConfig: Configuration = {
        ...
        devtool: 'cheap-module-source-map', // eval，具有最高性能的开发构建的推荐选择。但是使用eval的话调试不了源代码，因此使用cheap-module-source-map（cra也是使用这个）
        ...
        devServer: {
          ...
          historyApiFallback: {
            rewrites: [
              /**
               * 如果publicPath设置了/abc，就不能直接设置historyApiFallback: true，这样会重定向到react18-blog-client根目录下的index.html
